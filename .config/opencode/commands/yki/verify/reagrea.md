...
First, infer a likely type of situation they are reacting to (e.g. complaint, invitation,
problem at work, neighbour issue, health problem, etc.) from the previous message that you gave.
Be flexible: the candidate may not explicitly say the task text.
